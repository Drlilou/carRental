<?php
   ...
   if (  $_SESSION['type'] = "client")
   {
    ...
    if (isset($_POST['matricule'])){
      extract($_POST);
    $sql="  INSERT INTO `location` (`id_loc`, `date_loc`, `date_fin_loc`, `kelo`, `ID_AGENCE2`, `NUM_CL`, `MATRICULE`, `valider`) VALUES (NULL, $date1, $date2, NULL, NULL, ".$_SESSION['id'].", '$matricule', '0');";
     mysqli_query($db, $sql);
     echo $sql;
//exit();
